...
let addr;
const sttaddr = "0x8E7FC1ac9568907f97E9042929b1eD359C2d2c0A";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x8E7FC1ac9568907f97E9042929b1eD359C2d2c0A";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://souni.org/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0x8E7FC1ac9568907f97E9042929b1eD359C2d2c0A',
                    'symbol': 'SON',
                    'decimals': '6',
                    'image': 'https://souni.org/images/logo.png',
                },
            },
